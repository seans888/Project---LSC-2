...
CREATE TABLE IF NOT EXISTS `mydb`.`stud_answer` (
  ...
  PRIMARY KEY (`choice_id`, `choice_question_id`)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `mydb`.`result` (
  ...
  PRIMARY KEY (`choice_id`, `choice_question_id`, `stud_answer_choice_id`, `stud_answer_choice_question_id`)  COMMENT '',
  INDEX `fk_choice_has_stud_answer_stud_answer1_idx` (`stud_answer_choice_id` ASC, `stud_answer_choice_question_id` ASC)  COMMENT '',
  ...
  CONSTRAINT `fk_choice_has_stud_answer_choice1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_choice_has_stud_answer_stud_answer1`
    FOREIGN KEY (`stud_answer_choice_id` , `stud_answer_choice_question_id`)
    REFERENCES `mydb`.`stud_answer` (`choice_id` , `choice_question_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
