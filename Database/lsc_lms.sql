...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 03, 2016 at 11:33 AM
...
('delete-course', '2', NULL, NULL, NULL, NULL, 'delete-own-course'),
...
('update-course', '2', NULL, NULL, NULL, NULL, 'update-own-course'),
('update-student', '2', NULL, NULL, NULL, NULL, 'update-own-student'),
('update-task', '2', NULL, NULL, NULL, NULL, NULL),
('view-course', '2', NULL, NULL, NULL, NULL, 'view-own-course'),
...
('delete-own-course', NULL, NULL, NULL),
('update-own-course', NULL, NULL, NULL),
('update-own-student', NULL, NULL, NULL),
...
CREATE TABLE `user` (
  ...
  `review_class` enum('Senior High / College Entrance Review','High School Entrance lsc_lms / Science High School Review','Civil Service Exam Review','Law Aptitude Exam / Law School Admission lsc_lms Review','National Medical Admission lsc_lms Review') NOT NULL,
  `first_name` varchar(30) NOT NULL,
  `middle_name` varchar(30) DEFAULT NULL,
  `last_name` varchar(30) NOT NULL,
  `gender` enum('Female','Male') NOT NULL,
...
ALTER TABLE `auth_assignment`
  ADD PRIMARY KEY (`auth_item_name`),
